...
COPY --from=build /app/dist/runtime/treaty-server ./treaty-server

# Browser dist is required by SSR in source-entry compiled mode.
COPY --from=build /app/dist/treaty/browser ./dist/treaty/browser
